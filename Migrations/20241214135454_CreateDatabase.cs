    ...
    public partial class CreateDatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.AlterColumn<DateTime>(
                ...
                oldType: "DATETIME",
                oldMaxLength: 60,
                oldDefaultValue: new DateTime(2024, 12, 3, 0, 10, 44, 659, DateTimeKind.Utc).AddTicks(8111));
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.AlterColumn<DateTime>(
                ...
                maxLength: 60,
                nullable: false,
                defaultValue: new DateTime(2024, 12, 3, 0, 10, 44, 659, DateTimeKind.Utc).AddTicks(8111),
                oldClrType: typeof(DateTime),
                oldType: "DATETIME",
                oldMaxLength: 60,
